  ...
  <div>
    ...
    <section class="py-5 bg-light text-center hero">
      <div class="container">
        ...
        <a href="#" class="btn btn-dark btn-lg mt-3">Browse Frames</a>
      </div>
    </section>
...
<style scoped>
.hero {
  background-image: url("https://images.pexels.com/photos/4534200/pexels-photo-4534200.jpeg?auto=compress&cs=tinysrgb&w=600"); /* Replace with real background */
